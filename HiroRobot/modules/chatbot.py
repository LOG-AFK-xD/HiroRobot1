...
from HiroRobot import BOT_USERNAME as bu
from HiroRobot import BOT_ID, pbot, arq
from HiroRobot.ex_plugins.chatbot import add_chat, get_session, remove_chat
from HiroRobot.utils.pluginhelper import admins_only, edit_or_reply
...
@pbot.on_message(
    filters.regex("Nezuko|Nezuko|robot|Nezuko|Hiro")
    & ~filters.bot
    & ~filters.via_bot
    & ~filters.forwarded
    & ~filters.reply
