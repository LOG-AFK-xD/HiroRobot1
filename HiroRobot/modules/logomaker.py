...
from HiroRobot import telethn as tbot, ubot2
...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        fpath_ = glob.glob("./HiroRobot/resources/fonts/*")
    ...
    if os.path.exists(flnme):
        await tbot.send_file(
            event.chat_id,
            file=flnme,
            caption="Logo by [Nezuko](https://t.me/NezukoXRobot)",
    ...
    if os.path.exists(font_):
        if not font_.startswith("./HiroRobot/resources/fonts"):
            os.remove(font_)
