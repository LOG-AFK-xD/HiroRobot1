...
from HiroRobot.__main__ import STATS, TOKEN, USER_INFO
from HiroRobot.modules.sql import SESSION
import HiroRobot.modules.sql.userinfo_sql as sql
from HiroRobot.modules.disable import DisableAbleCommandHandler
from HiroRobot.modules.sql.global_bans_sql import is_user_gbanned
from HiroRobot.modules.sql.afk_sql import is_afk, set_afk
from HiroRobot.modules.sql.users_sql import get_user_num_chats
from HiroRobot.modules.helper_funcs.chat_status import sudo_plus
from HiroRobot.modules.helper_funcs.extraction import extract_user
from HiroRobot import telethn
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Hiro Statistics 」</b>\n" + "\n".join(
