...
from HiroRobot.modules.helper_funcs.decorators import Hirocmd, Hiromsg
from HiroRobot.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from HiroRobot.modules.sql.antichannel_sql import (
    antichannel_status,
    disable_antichannel,
    enable_antichannel,
)
...
@Hirocmd(command="antichannelmode", group=100)
...
@Hiromsg(Filters.chat_type.groups, group=110)
