...
from HiroRobot import arq
from HiroRobot.services.keyboard import Ikb
from HiroRobot.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from HiroRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from HiroRobot.services.types import InlineQueryResultCachedDocument
from HiroRobot.modules.info import get_chat_info, get_user_info
from HiroRobot.utils.functions import test_speedtest
from HiroRobot.utils.pastebin import paste
